...
## 📸 Hasil Praktikum (Wajib)

### 1. Struktur Project

📌 Screenshot folder project di VS Code

---

### 2. Generator Berjalan

📌 Screenshot terminal saat generator aktif

---

### 3. Spark Streaming

📌 Screenshot proses streaming berjalan

---

### 4. Folder Serving

📌 Screenshot isi folder:

```bash
data/ atau stream_data/
```

---

### 5. Dashboard (Insight + Alert)

📌 Screenshot dashboard Streamlit:

* Grafik data
* Insight
* Alert (misalnya harga tinggi / anomali)
...
* Harga di atas threshold tertentu
